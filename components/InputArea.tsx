    ...
    <div className="w-full max-w-2xl mx-auto px-4 relative z-20">
      ...
      <div 
        className={`
            ...
            ${isDragging ? 'border-blue-500 shadow-[0_0_30px_rgba(59,130,246,0.2)]' : 'border-zinc-700 shadow-2xl'}
      ...
      >
        ...
        <div className="p-2">
            <textarea
                ...
                placeholder="Describe your app idea (e.g. 'A full-featured food delivery app with checkout')..."
      ...
      {/* Drag Overlay */}
      {isDragging && (
          <div className="absolute inset-0 m-4 rounded-xl border-2 border-dashed border-blue-500 bg-zinc-900/90 backdrop-blur-sm z-30 flex flex-col items-center justify-center text-blue-400 pointer-events-none">
      ...
      {!isGenerating && !prompt && !attachedFile && (
        <div className="mt-6 flex flex-wrap justify-center gap-3">
            <SuggestionChip text="Complete E-Commerce App with Checkout" onClick={() => setPrompt("Full e-commerce app for sneakers with home, search, product details, cart, and checkout flow.")} />
            <SuggestionChip text="Social Fitness App System" onClick={() => setPrompt("Social fitness app with activity feed, profile, workout tracker, and messaging screens.")} />
            <SuggestionChip text="Modern Crypto Wallet Dashboard" onClick={() => setPrompt("Dark mode crypto wallet with portfolio graph, coin list, send/receive screens, and settings.")} />
            <SuggestionChip text="Travel Booking Flow" onClick={() => setPrompt("Travel app for booking hotels with search results, hotel details, and booking confirmation.")} />
        </div>
      )}
